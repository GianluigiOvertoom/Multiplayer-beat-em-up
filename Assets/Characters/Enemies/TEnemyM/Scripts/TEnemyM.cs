...
public class TEnemyM : Enemy
{
    ...
    protected override void Start()
    {
        base.Start();
        EnemyAggro = 0;
        EnemyState = new TEnemy_State_Idle(this);
    }
    ...
    public void CheckForAttack()
    {
        ...
        {
            SwitchState(new TEnemy_State_Attack(this));
        }
    }
    ...
    public void SwitchRandomState()
    {
        ...
        {
            case 0:
                SwitchState(new TEnemy_State_Idle(this, 1f));
                break;
            case 1:
                SwitchState(new TEnemy_State_Retreat(this, 0.5f));
                break;
            case 2:
                //Patrol to a random point
                SwitchState(new TEnemy_State_Chase(this, 0.5f));
                break;
            case 3:
                SwitchState(new TEnemy_State_Chase(this, 0.5f));
                break;
